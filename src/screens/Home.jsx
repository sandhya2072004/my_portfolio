...
import { ThemeContext } from "../ThemeContext"; // wherever your context file is
...
export default function Home() {
  ...
  return (
    <Box sx={{ width: '100%', overflowX: 'hidden' }}>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 w-full max-w-7xl">
              ...
              >
                <img
                  ...
                  style={{
                    ...
                    height: "100%",
                    objectFit: "cover",
                    borderRadius: "50%", // Ensure image is also circular
                  }}
                />
              </div>
            ...
            <div className="flex-1 flex flex-col justify-center items-start space-y-6">
              ...
              <div className="flex flex-row gap-5">
                ...
                <Button variant="outlined" startIcon={<GitHubIcon/>} sx={{ textTransform: "none", borderRadius: "30px", color: "#960D51", borderColor: "#960D51" }} href="https://github.com/sandhya2072004" target="_blank">
               Github
                </Button>
                <Button variant="outlined" startIcon={<LinkedInIcon/>} sx={{ textTransform: "none", borderRadius: "30px", color: "#960D51", borderColor: "#960D51" }} href="https://www.linkedin.com/in/sandhya-sahu-0a8aa9269/" target="_blank">
                 LinkedIn
                </Button>
              </div>
            </div>
      ...
      {/*About section*/}
      <Box id="about" sx={{ p: 4 }}>
        <div className=" text-black px-6 py-10 flex flex-col items-center justify-center mt-20">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-8 w-full max-w-6xl">
            <div className="outside-vertical-line h-[450px] mt-4"></div>
            ...
            >
              {/* Vertical Line */}
              <div className="vertical-line-animated"></div>
      ...
      <Box id="skills" sx={{ p: 4 }}>
        <div id="skills" className=" min-h-screen flex flex-col items-center py-10">
          <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", mb: 4 }}>
            <Typography variant="h6" sx={{ color: "black", fontWeight: "bold", fontSize: "30px", mt: 1 }}>
              Skills
            </Typography>
          </Box>
